...
for target_COMMODITY in COMMODITYS:
    ...
    output_file_path = f'model_results/{target_COMMODITY}_{keyword}_{WINDOW_SIZE}/test/results_test.csv'
    pred_file_path = f'model_results/{target_COMMODITY}_{keyword}_{WINDOW_SIZE}/test/predictions/test'
    model_path = f'model_results/{target_COMMODITY}_{keyword}_{WINDOW_SIZE}/best_model'
